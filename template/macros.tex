...
\newcommand{\cds}[1]{\href{https://cds.cern.ch/record/#1}{cds:#1}}
\newcommand{\pas}[1]{\href{https://www.cern.ch/cms-physics/public/#1-pas.pdf}{CMS-PAS-#1}}
\newcommand{\pasNoPub}[1]{CMS-PAS-#1}
\newcommand{\an}[1]{\href{http://cms.cern.ch/iCMS/jsp/db_notes/noteInfo.jsp?cmsnoteid=CMS AN-#1}{CMS-AN-#1}}
