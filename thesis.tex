...
%==============================================================
    ...
    TeV + talk about the Higgs discovery at some point + table showing data-taking periods and Phase I, Phase II, etc}

    \todo{explicit link between track curvature and momentum measurement}
    ...
    \insertTwoFigures{LHClayout}
                     ...
                     injection, acceleration (RF) and beam dump. \todo{if time, redo the
                     bottom sketch not be nicer/clearer}}
    ...
    are given on \reffig{fig:partonDistributionFunctionsExample}. The shape of this
    ...
    \insertFigure{partonDistributionFunctionsExample}{0.7}{Example of PDFs
    for two different energy scale $Q$, provided by the MSTW group \todo{confirm "group" ?}. At lower energies,
    ...
    \section{The Compact Muon Solenoid experiment}
        ...
        represented on \reffig{fig:CMS/triggerL1}. The first stages, the regional calorimeter
