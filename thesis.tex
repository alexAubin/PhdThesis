...
\todo{also mention that in natural scenario, expect 'light' gluinos ?}
...
elements helped build in the modern Standard Model of particle physics which has since
...
magnitude lower than the scale of gravitation, a problem known as the hierarchy
...
experimental signature composed of one lepton, four jets, and missing energy. The search
is performed using data collected during collisions at a center of mass energy $\sqrt{s}
= 8\TeV$. After discussing the phenomenology and signature of this search,
the document presents the different contributions that were developed during this thesis.
A focus is made on the design of a second lepton veto to reject one of the main background
of the analysis. After this, it is discussed how the cut-based version of the analysis
has been designed and optimized. The different aspects of the background estimation are
...
we present how the background estimation is corrected during the interpretation. After
presenting the results of the analysis, we go through prospectives studies, first to
...
%==============================================================
    ...
    Quantum field theory \cite{Polonyi, Ryder} apply the idea of quantum mechanics to fields, by treating the
    ...
    exchange of virtual photons. Virtual particles are not observable per se, but are a
    ...
    where the terms $T$ and $V$ describe respectively the kinetic and potential of the
    ...
    a term with the form $\phi \phi$ corresponds to a mass term for the field $\phi$,
    ...
    belongs to the adjoint representation of $SU(n)$. The covariant derivative for the
    ...
    for the gauge bosons break the symmetry. For instance, one cannot have a massive photon
    in quantum electrodynamic because it is not invariant by gauge transformation:
    \eq{massivePhoton}
    {
    ...
    massive fermions, via a spontaneous breaking of this symmetry first introduced by
    Robert Brout, François Englert and Peter Higgs \cite{EnglertAndBrout,Higgs}.

    \subsubsection{Spontaneous breaking of the electroweak symmetry}

    In this section, we describe explicitly how the introduction of the Higgs field leads
    to the spontaneous breaking o the electroweak symmetry \cite{LectureStandardModelHiggsBoson}.
    ...
    For $\mu^2 < 0$ and $\lambda > 0$, one gets a non-trivial shape for the potential,
    ...
    \bar{e} e$. Additionnaly, the field $e$ couples to the Higgs boson with strength
    ...
    cosequence, to split a hadron into individual quarks, someone will need to give energy
    to the system up to the point where this energy will be converted into new colored
    particles coming out of vaccuum, and will form new hadrons. This leads to the concept of
    ...
    In the previous section, we have seen how the particle masses arises from the
    ...
    the $SU(2)_L \times SU(2)_R$ invariance of the QCD Lagrangian, down to a isospin symmetry
    $SU(2)_V$.

    \subsection{The success of the Standard Model \label{sec:standardModelSuccess}}
    %====================================================================================

    The Standard Model includes 19 free parameters: nine fermions masses, one scalar mass,
    three coupling parameters, four quark mixing matrix parameters, the Higgs vaccum expectation
    ...
    at the LEP experiments, the Belle and BaBar experiments, and at the Tevatron collider. In 2012,
    the CMS and ATLAS experiments at the LHC discovered the last remaining particle of the
    Standard Model, the Higgs Boson with a mass $\mass{h} \sim 125\GeV$. The mass
    ...
    \reffig{fig:theory/standardModelFit} shows the result of a global fit of Standard
    Model observables \cite{GFitter}. In such a fit, one observable at a time is set free
    ...
    \insertFigure{theory/standardModelFit}{0.46}
                 {Global fit of observables of the Standard Model \cite{GFitter}.}
    ...
    theory valid only at low energy and hiding a higher degree of symmetry at high energy.
    ...
    term (i.e. from spontanneous symmetry breaking), the property should still hold in
    ...
    of rotation curves of galaxies. These curves showed the evolution of the orbital velocity
    ...
    with distance, stayed approximately constant \cite{Begeman}.
    ...
    provided indirect evidences for the existence of such dark matter \cite{DMPrimer}. Among them,
    ones is using the technique of gravitational lensing that allows the observer to
    ...
    cold, that is to say that it must have low kinetic energy, which rules out neutrinos
    ...
    the relic density $\Omega_X$ \cite{DMPrimer, NeutralinoRelic, WIMPRelic}. The
    relic density is proportional to $m_X^2 / g^4_X$ where $m_X$ is the mass of the dark matter particle
    and $g_X$ is the coupling constant in co-annihilaion process $XX \leftrightarrow f\bar{f}$.
    It is remarkable to note that taking $\Omega_X = \orderOf{0.1}$ from cosmological
    observations and $g_X \sim 0.6$ from the weak interaction, then we expect $m_X =
    \orderOf{100\GeV}$. This encourage physicist to look for weakly interacting massive
    ...
    \begin{itemize}
        ...
        \item \textbf{Strong CP problem} - As introduced before, there is a term allowed in
            ...
            similar to the hierarchy problem where we can expect that there is a hidden mechanism
            protecting this phase to be too different from zero.
    ...
    %====================================================================================
        ...
        criteria to be cold dark matter candidates. In particular, axions are predicted to
        ...
        is only composed of 3+1 (space and time) dimensions, theoretical mechanisms have been
        discovered that could explain why additional dimensions are not noticeable at our scale.
        ...
        Large extra dimensions (ADD) \cite{ADD} theories are based on the idea that the Standard Model
        ...
        be diluted while at low distances (i.e. high energies) the Standard Model interactions
        and gravitation would have coupling constants that are of the same order. A phenomenological
        ...
        The Randall-Sundrum (RS) \cite{RS} scenarios consider a five dimensions universe made of two
        four-dimensions branes separated by an extremely warped fifth dimension. One of
        the brane corresponds to the Standard Model physics while the other brane would correspond
        to the realm of gravity. The distance separating the two branes is directly linked to
        the difference of energy scales between the Standard Model sector and the gravitation
        sector. A phenomenological prediction of these models is the production of gravitation
        excitations at the TeV scale.

        Finally, universal extra dimensions (UED) \cite{UED} theories are based on the idea that
        ...
        tight constrains on the existence of such a fourth family, starting with with
        ...
        Alternativly, focusing exclusively on the dark matter problem, it has been proposed
        ...
        Finally, one elegant idea to try to explain the lightness of the
        Higgs is to consider it as a composite object \cite{LittleHiggs, CompositeHiggs}.
        This idea is inspired from QCD where
        light scalars are encountered and do not exhibit a naturalness problem. Pions,
        for example, can be seen as Goldstone bosons of the spontaneous breaking of chiral
        symmetry, and therefore are massless. However in practice, chiral symmetry is not exact as
        the underlying quarks do have mass,
        thus pions are only pseudo-Goldstone boson and get a mass,
        but they are still protected from being heavy by the approximate chiral symmetry.
        Applying the same idea to the Higgs would therefore answer the hierarchy problem.
        This also means that there would be a new interaction whom the Higgs would
        be just the lightest hadron-like state and other states could be seen at higher
        ...
        the fine-tunning in the hierarchy problem and the arbitrariness of the other parameters
        of the theory.
        ...
        This view is however controversial as it yields very little, if not no, testable
        ...
        russians mathematicians were working with the space-time symmetries of the Poincaré
        ...
        Lorentz group, that is to say fermions ($f$) and bosons ($b$):
        ...
        Colemand and Mandula \cite{ColemandMandula} that the only possible symmetry of Nature are the
        ...
        is associated a fermion. The particule associated to an other by SUSY is called
        ...
        we assume $r = 100$, then we are left with a correction $\Delta m_h = \orderOf{100 \cdot m_t}$
        ...
        higgsinos, but a second Higgs $SU(2)$ doublet to avoid a gauge anomaly.
        ...
        phenomenology. The introduction of second Higgs $SU(2)$ doublet leads to four addtional
        physical Higgs states noted $H^0$, $A$ and $H^\pm$.
        In the supersymmetric sector, masses eigenstates are formed by the combinations of
        ...
        By design, the MSSM conservs a quantum number called R-parity defined as:
        \eq{RparityDefinition}
        {
            R = (-1)^{2S + 3B + L}.
        }
        where $S$ is the spin, $B$ the baryon number, and $L$ is the lepton number. $R$ is 1 for the particles of the Standard Model and -1 for their superpartners.
        ...
        The phenomenological MSSM (pMSSM) reduces this number of parameter by assuming that
        ...
        \begin{itemize}
            \item the ratio of the Higgs vaccuum expectation values, and $\text{tan}\, \beta \definedAs v_2 / v_1$ (with $0 \leq \beta \leq \frac{\pi}{2}$) ;
            \item the higgsino mass parameter $\mu$ and pseudo-scalar Higgs mass $\mass{A}$ ;
            \item the soft gaugino masses $M_1$, $M_2$ and $M_3$, corresponding respectively to the bino, wino and gluino masses\footnote{One can notice that the index in $M_{1,2,3}$ refers to the gauge groups $U(1)$, $SU(2)$ and $SU(3)$, which makes it easier to remember which gaugino it refers to.} ;
        ...
        One can go one step further and reduce this number of parameter to 5 in the case
        ...
        and all the trilinear couplings are the same with value $A_0$. The remaining
        ...
        To get a better and concrete idea of the phenomenology of the neutralino, chargino
        ...
        the same kind of matrix that arised when we described the electroweak symmetry
        breaking and which led to the introduction of the physical states $W^\pm$, $Z$ and
        $\gamma$.
        ...
        depends on $M_1$, $M_2$, $\beta$ and $\mu$.
...
%==============================================================
    ...
    \reffig{fig:partonDistributionFunctionsExample}. The shape of this
    ...
    for two different energy scale $Q$, provided by the MSTW group \cite{MSTWpdfs}. At lower energies,
    ...
    to the hard scattering leading to a $\gamma^*/Z$ resonance which decays into two
    ...
    and the LHC ($\sqrt{s} = 14\TeV$) \cite{ppCrossSectionsStirling}}
    ...
    \section{The Compact Muon Solenoid experiment}
        ...
        The CMS detector \cite{CMSdetector} is an instrument that answer the fantastic challenges posed by
        ...
        \insertFigure{CMS/ECALcrystal}{0.6}{PbWO$_4$ crystal used in the ECAL with the photodiode
        ...
        \section{Collisions and detector simulations}
            ...
            Finally, this description focused on tree-level diagrams, but a more accurate
            ...
            \textsc{Geant4} \refNeeded. Its description can be tuned to study, for instance,
...
\emph{« Amy: Shall I run and get the manual?\\
...
%==============================================================
    ...
    $b$ quarks are found in the final state of a large variety of Standard Model or BSM processes
    involving top quarks, $Z$ or Higgs bosons.
    ...
    by a large fraction of analysis in the CMS collaboration, to select or reject processes.
    ...
    \begin{itemize}
        \item \textbf{Large mass} - $B$ hadrons have masses ranging from $5$ to $10\GeV$, as
              they contain a $b$ quark which have a mass around $4.5\GeV$. Such a mass is
        ...
        \item \textbf{Leptonic decay} - As the decay of $B$ hadrons involve a virtual $W$ boson,
    ...
    real life example of event containing $b$-tagged jet is shown on \reffig{fig:bTagging/vbfHbb_Candidate},
    taken from a search for $H\rightarrow b\bar{b}$ in the CMS collaboration.
    ...
    \insertFigure{bTagging/impactParameter}{0.75}
                 ...
                 hadron and the other from the decay of
    ...
    vertex position varies between 100 and 10~$\mum$. This is less than the typical decay length
    ...
    the mass of $K_0$ or higher than $6.5\GeV$ are rejected.
    ...
    leptons inside the different categories of jets, showing the discriminating power that
    they provide.
    ...
    \begin{figure}[th!]
        ...
        for electrons and muon inside different jet categories \cite{SoftLeptonAN}.}
    ...
    whose distribution provides good discrimination between $b$ jets and other jet flavors.
    One then defines an operating point, or threshold, such that jets with discriminant
    higher than the threshold are said $b$-tagged.
    ...
    value. To benchmark the performances and allow easier comparison
    ...
    (TCHE). Using the third track $S_\text{IP}$ as discriminant leads to a drop in the
    ...
    small spikes in the discriminat distribution, also visible in the performance curves,
    come from the lower bound on $P_\text{track}$. The $b$ jet efficiency are around
    ...
    Finally, one wants to combine the techniques previously described. as they complement
    ...
    performances of the CSV algorithm. At the loose working point, the $b$ et efficiency is
    ...
    object groups and analysis groups. The frequency of such a validation procecure
    ...
    The preparation for the Run II of the LHC involves a change in the jet size parameter.
    ...
    A comparison of the jets $\pT$ and $\eta$ spectra between the two reconstruction
    ...
    presents on the distribution of the $\Delta R$ between a given track and the jet
    axis. Small differences are observed
    ...
    Two of the $b$-tagging variables are presented on the bottom of
    ...
    \insertFourFigures{bTagging/AK4vsAK5/TTbar_FullSim_PU_lowLevelVariables}
                      ...
                      significance (bottom left) and flight distance significance of the
                      secondary vertex (bottom right) in the context of the validation
                      of the new jet size parameter for Run II. On the bottom of the plots,
    ...
    sgnificance, has a $b$ jet efficiency improved by a few percents attributed to the
    ...
    \insertFourFigures{bTagging/AK4vsAK5/TTbar_FullSim_PU_performances}
                      ...
                      parameter for Run II. On the bottom of the plots, the histogram corresponds
                      to the ratio of the distribution between $R = 0.4$ and $R = 0.5$.
                      }
...
%                     in the context of the validation of \textsc{Geant4} 10.0.patch1.}
    ...
    samples was changed from 10 to 35. This should be differentiate from the pile-up rate
    used for analysis samples which follows a particular pile-up distribution.
    As tracking and $b$-tagging variables strongly depends on pile-up effects, this
    ...
    reconstruction, as function of $\eta$, between a pile-up rate of 10 (\emph{old}) and
    ...
    case of premixing, the idea is to factorize the simulation of the interaction with the
    detector coming from, on one hand, the pile-up, and on the other hand, the hard-scattering
    of interest. By doing so, the pile-up particles interaction can be computed once for
    ...
    of tracks and calorimeters and therefore allows an overall check that premixing does
    ...
    rate from lights jets in the medium working point region while SSVHE gets about 20\%
    ...
    idea of the performance of the detector in these conditions, anticipate possible
    ...
    comparison is made with a sample with a Phase 1 aged geometry, a pile-up of 140, and
    the process considered is $t\bar{t}$.
    ...
    number of selected tracks is significantly lower for all tracks category, interpreted
    ...
    5 to 10 in the high PU scenario.
    ...
    \insertTwoFigures{bTagging/highPU/TP}
                     ...
                     {0.49}
                     {Comparison of the primary vertex choice efficiency as function of the
                     ...
                     technique, and Phase 2 detector with a pile-up rate of 140 (red dots) \cite{Phase2TDR}.}
...
%==============================================================
    ...
    \refsection{sec:analysis_perspective}, some of the perspectives for this analysis
    ...
    %==============================================================
        ...
        function of $X_t$, as shown on the left of \reffig{fig:stopSectorConstraints} when assuming $\text{tan}\, \beta
        ...
        Moreover, it is remarkable that constrains on the stop sector can also be derived
        ...
        %In this subsection, we introduce the processes and phenomenology of the search for
        %direct stop pair production that has been introduced and will be discussed in
        ...
        All of these four decay hypotheses will be studied independently
...
$\lstop \rightarrow b \lchargino$ (0.5/450/50) & 248 $\pm$ 16        & 167 $\pm$ 14  & 146 $\pm$ 13  \\
    ...
    \subsection{Discriminating variables \label{sec:analysis_variables}}
        ...
        the background and signal on \reffig{fig:variables/leadingBPt} and illustrates the
   ...
   \end{equation}
    ...
    \begin{enumerate}
      ...
      \item It ultimately relies on a gaussian approximation which can cause significant
            ...
            \reffig{fig:FOMcomparison} shows a comparison of $S/\sqrt{B}$ versus an exact
            computation.
    \end{enumerate}
    ...
    merit defined in formula \refequation{FoM}. To work around cases with very low background or signal yields,
...
\end{table}
    ...
    as shown on \reffig{fig:templateFitCnCResultsMET}.
    ...
    The values found are $\SFRoneLeptonTop = (1.38 \pm 0.61)$ and $\SFRWjets = (1.21 \pm 0.36)$.
        ...
        The background prediction in the signal region is obtained by taking the Monte-Carlo
    ...
    On the left of \reffig{fig:resultsCnC} and \reffig{fig:resultsBDT}, comparisons
    ...
    \begin{figure}[h!]
        ...
        with $x=0.75$, $0.50$ and $0.25$ respectively. \todo{Maybe put this in landscape}}
    ...
    \subsection{$W$-tagging in the high $\Delta m$ regime}
        ...
        While this gain can be thought to be small, other small investigations have been
...
in particular for direct stop pair production. Two possible decay chains were considered:
...
$\MET$. The analysis was built around the $\MT$ variable, defined as the transverse mass of the lepton
and $\vec{\MET}$ system, which provides great discriminating power between signal and background.

The first contribution to the analysis was the improvement of the
second lepton veto based isolated track identification, and the development of an
...
of the lepton is lost. It was estimated that the current veto rejects about 60\% of this
background, corresponding to a gain in sensitivity about 25\%.

This contribution was followed by the design and optimization of cut-based signal regions
for the analysis, motivated by the better control and transparency offered by this approach
compared to the more sophisticated techniques such as boosted decision trees.
This work required to develop a good understanding of the relevance of the
...
allowed to cross-check the boosted decision tree approach, and were sometimes found to
...
by the $\oneLeptonTop$ and $\Wjets$ backgrounds. This method allowed a more reliable prediction
of these backgrounds in particular compared to previous techniques. In addition, signal
contamination was noticed not to be negligible in the control regions of the analysis,
and the background estimation had to be modified to obtain a rigorous prediction of the
background, as function of the signal benchmark considered.

After the Run I of the LHC, no significant excess has been observed, and the results were
interpreted in terms of upper limit on the signal cross-section, as function of the masses of
the stop and neutralino, $\mass{\lstop}$ and $\mass{\lneutralino}$. After comparing this upper
...
decay mode, this constrain goes up to around $700\GeV$ for the mass of the stop,
and around $250\GeV$ in term of neutralino mass. While these results disfavor the idea of
a natural supersymmetry, there are still a large portion of phase space where this signal
could be awaiting to be discovered, not only at higher masses but also in the stealthy
region and compressed spectra region.
...
relevant for boosted and hadronically decaying $W$ bosons. We demonstrated that
this technique indeed holds potential that could be exploited during the Run II. In parallel,
 we estimated the sensitivity of the analysis for the beginning of the Run II. Using a
simplified version of the Run I analysis, it was found that, for instance, one can expect
