...
%==============================================================
    ...
    a pile-up of 50, and the conditions of the technical design report (TDR) \todo{ref phase 1}. The
...
%==============================================================
    ...
    Interestingly, the observed Higgs mass therefore points to relativly ``heavy''
    ...
    Moreover, the naturalness argument also motivates $\mu$ to be lower than around
    $200\GeV$ and therefore light Higgsinos. Following this, it means that neutralinos
    should be relatively light, and though the exact constraint depend on assumptions
    on $\text{tan}\, \beta$, $M_1$ and $M_2$, it is safe to consider that the lightest
    neutralino should be lighter than around $500\GeV$.
...
\insertTwoFigures{stopMassSpace}
    ...
    and its key parts, which will then help to understand how each piece fit into the
    ...
    also represents a personnal contribution.
    ...
    of this chapter, some futher studies for the future of the analysis are presented,
    ...
    \begin{tabular}{|c|c|ccccc|c|}
        ...
        \hline
    \end{tabular}
        \caption{Selection effiencies when applying the two vetos, estimated on the different
...
$\lstop \rightarrow b \lchargino$ (0.5/450/50) & 248 $\pm$ 16        & 167 $\pm$ 14  & 146 $\pm$ 13  \\
    ...
    \subsection{Discriminating variables \label{sec:analysis_variables}}
        ...
        \insertTwoFigures{METvsSqrtHT}
                         ...
                         {Distribution of $\sqrt{H_T}$ versus $\MET$ for the the
    ...
    \begin{itemize}
        \item $\pT(\ell)$, $\pT(\text{leading jet})$ ; As already mentionned, the $\pT$ of the
    ...
    signal exists. It is generally more pratical to express this potential in term of a
