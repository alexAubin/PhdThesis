...
%==============================================================
    ...
    \refsection{sec:standardModelShortcomings} discuss the shortcomings of the Standard
    Model with a particular focus on the hierarchy problem and dark matter. Finally,
    \refsection{sec:beyondTheStandardModel} introduces the theories beyond the Standard
    Model that attempt to adress these shortcomings, and in particular supersymmetry.
    ...
    be obtained from perturbative QCD. \refNeeded
    ...
    instead rely on experimental measurements. \refNeeded
    ...
    (LO) by considering only the first diagram in the development, or next-to-leading-order (NLO) \todo{clarify in terms of $\alpha$}
    ...
    at the LEP collider \refNeeded, the Belle and BaBar experiments \refNeeded, and at the Tevatron collider \refNeeded. In 2012,
    ...
    %====================================================================================
        ...
        group whose gauge boson would be a ``dark'' photon \refNeeded.
        ...
        breaking in \refsection{sec:spontanneousElectroweakSymmetryBreaking} and which led
