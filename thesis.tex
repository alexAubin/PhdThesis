...
%==============================================================
    ...
    %====================================================================================
        ...
        equivalent to natural selection at the scale of the multiverse where the observed
        ...
        \todo{ref Aurélien Barrau - Quelques éléments de physique et de philosophie des
        multivers}
        ...
        the same kind of matrices that arose when we described the electroweak symmetry
...
%==============================================================
    ...
    \section{The Compact Muon Solenoid experiment \label{sec:CMSexperiment}}
        ...
        a precision on the vertex to less than one millimeter.
...
%==============================================================
    ...
    technique has been developed. This technique starts clustering tracks to create jets,
...
%==============================================================
    ...
    of the other parameters of the theory, e.g. assuming that $\mass{A} \gg \mass{Z}$:
    \eq{higgsMassInSUSY}
    {
        \mass{h}^2
        =
    ...
    $200\GeV$ and therefore light Higgsinos \cite{NaturalSUSYAndDarkMatter}. Following this,
    it means that neutralinos should be relatively light, and though the exact constraint
    depend on assumptions on $\text{tan}\, \beta$, $M_1$ and $M_2$, it is safe to consider
    that the lightest neutralino should be lighter than around $500\GeV$.
...
\insertTwoFigures{stopMassSpace}
    ...
    hadron-plus-strips (HPS) algorithm \cite{TauID} \todo{describe principle}. To reject fake
...
$\mass{\lstop}$ and $\mass{\lneutralino}$. After comparing
...
in the hight $\deltam$ region. This technique, based on the analysis of the jet substructure, is
