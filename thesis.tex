...
%==============================================================
    ...
    \section{Topology and tagging algorithms of $b$ jets \label{sec:bTagAlgorithms}}
    ...
    of the $b$ jet efficiency. Three operating points are defined on this curve : the
    loose, medium and tight working points, defined such that the fake rate for light jets
    is respectively 10, 1 and 0.1\%.
    ...
    actually reconstructing a secondary vertex which satisfies the constrains. In the
    ...
    lepton flavor is instricly limited by the leptonic branching ratio of $B$ hadrons,
    about 15-20\% per flavor.
    ...
    to these numbers. This efficiency is about 0.5\% for lights jets, meaning that
    the fake rate estimation cannot reliably be probed around the tight working point.
    ...
    steps of previous validation samples, in order to remove the randomness coming from
    these steps.
