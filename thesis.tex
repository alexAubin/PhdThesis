...
%                     in the context of the validation of \textsc{Geant4} 10.0.patch1.}
    ...
    a pile-up of 140. The Phase 2 geometry allows to significantly reduce the fake rate
    from light jets to obtain performances comparable to Phase 1 with a pile-up rate of 50.
