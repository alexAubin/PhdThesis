...
%==============================================================
    ...
    \section{The Compact Muon Solenoid experiment}
        ...
        complementary layers as represented on Figure \ref{fig:CMS/detectorOverview}.
        ...
        aggregate the softer objects.

        The second algorithm, called Cambridge/Aachen algorithm, uses the metric from Eq.
        ...
        An example of jet reconstruction is show in Figure \ref{fig:CMS/jetExample}. Figure
        \ref{fig:jetEfficiencies}
        ...
        As for the jets, several $\MET$ can be computed depending on the choice of the object
        collection which can be energy deposits in the calorimeters, tracks or the
        particle flow collection. Detector effects such as tresholds in the calorimeters,
        or acceptance effects generally lead to artificial $\MET$ in addition to the
        actual contribution of invisible particles. One of the challenge of $\MET$ reconstruction
        is therefore to understand the different sources of bias and smearing and correct
        for them to improve its resolution.

        \subsection{Collisions and detector simulations}
