...
\todo{recheck comments from Dirk on intro}
...
%==============================================================
    ...
    %====================================================================================
        ...
        \begin{itemize}
            \item the higgsino mass parameter $\mu$ and pseudo-scalar Higgs mass $\mass{A}$ ; \todo{maybe check the exact terminology for mu}
        ...
        \todo{implement comments from Pascal about the end of this chapter, e.g. natural susy spectra, ...}
...
%==============================================================
    ...
    energy, justifying this choice for the LHC \todo{decide about this}. We will see however, in
    ...
    geometry parameters. \todo{add luminosity formula?} The two general purpose experiments, ATLAS and CMS, are designed
    ...
    The resolution measured using electrons is parametrized using the formula \todo{state where this is coming from i.e. test beam or LHC data}
    \eq{ECALresolution}
    {
    ...
    \eqalign{ECALresolution2}
    {
        ...
        C & = 0.003\text{, the constant \todo{global or local ?} contribution.}\nonumber
    }
    ...
    The energy resolution measured for pions is \todo{state where this is coming from i.e. test beam or LHC data}
    \eq{HCALresolution}
    {
        \left( \frac{\sigma_E}{E} \right)
        =
    ...
    \eqalign{HCALresolution2}
    {
        ...
        C & = 0.074\text{, the  \todo{global or local ?} constant contribution.}\nonumber
    }
    ...
    \begin{itemize}
        \item \textbf{Drift tubes} (DT) - This technology uses stretched wires within
            ...
            the difference of current collected at both extremity of the wire \todo{check this}, and knowing
    ...
    respectively \todo{ref ? source of measurements ?}.
    ...
    \todo{in this subsection : discuss object reconstruction systematics ? JES, JER, MET, LES, ... relevant analysis}
    \todo{add lepton reconstruction / perf discussion ?}
...
%==============================================================
    ...
    \begin{figure}[th!]
        ...
        for muons inside different jet categories \cite{SoftLeptonAN}. \todo{clarify conditions used for the plot}}
    ...
    coming from these steps \todo{maybe clarify this paragraph}.
...
%==============================================================
    ...
    \insertFigure{stopDecayModes}{0.8}
                 ...
                 are studied, $x = 0.75$, $0.50$ and $0.25$. \todo{maybe flag these as T2tt and T2bw}}
...
\end{table}
    ...
    up to $\mass{\lstop} = 780\GeV$ when $\mass{\lneutralino} < 200\GeV$. \todo{add ref to SUS-13-023}
    ...
    ISR jet identification, following the same arguments described in \refsection{sec:ISRjets}.
    ...
    $190\GeV$ for $\mass{\lneutralino} = 1\GeV$, as presented in \reffig{fig:stealthyStops}
    ...
    space, as shown on \reffig{fig:stealthyStops} \todo{ref to SUS-13-024}, which
    can be put in parallel to theoretical constrains such as dicussed in \refsection{sec:theoreticalContextAndConstrains}.
...
\newpage
\thispagestyle{empty}
\newgeometry{top=1.5cm, bottom=1.5cm, left=1.8cm, right=1.8cm, bindingoffset=0cm}
\singlespace
