...
%==============================================================
    ...
    \insertTwoFigures{MTatPreselection}
        ...
        \subsection{Cut-based signal regions}
            ...
            This section discuss the optimization of signal regions in the cut-based approach.
            First we introduce the figure of merit that is used to perform the optimization,
            then the optimization procedure itself and finally the results and performances obtained.
