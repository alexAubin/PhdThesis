...
%==============================================================
    ...
    \section{The Compact Muon Solenoid experiment}
        ...
        because of the transfer speed, memory and computing power it would require. Therefore,
        a selection must be applied online to reduce the rate to a more realistic one,
        set to about $400~$Hz.
