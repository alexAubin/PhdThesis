...
%==============================================================
    ...
    Experiment (CMS). In \refsection{sec:LHCintro}, we introduce the LHC apparatus,
    ...
    \section{The Compact Muon Solenoid experiment \label{sec:CMSexperiment}}
        ...
        The Compact Muon Experiment experiment \refNeeded is one of the four experiments installed
        ...
        \todo{rework this paragraph} So far, the CMS experiment, through the analysis of the Run I data at
        ...
        \section{Collisions and detector simulations \label{sec:simu}}
            ...
            Finally, the previous description focused on tree-level diagrams, but a more accurate
