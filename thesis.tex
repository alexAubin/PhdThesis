...
%==============================================================
    ...
    \section{Systematic uncertainties \label{sec:analysis_systematics}}
        ...
        \subsection{Systematic uncertainties on the background}

            \subsection{Second lepton veto efficiency}
            ...
            \subsection{Modeling of $\diLeptonTop$}
            ...
            \subsection{Modeling of $N_\text{jets}$ for $t\bar{t}$}

            b

            \subsection{Cross section of $\oneLeptonTop$, $\Wjets$ and rare components}
            ...
            \subsection{Statistic uncertainty in $\MT$ peak}
            ...
            \subsection{Uncertainty on $SFR_{\oneLeptonTop}$ and $SFR_{\Wjets}$}
            ...
            \subsection{Limited statistic of the Monte-Carlo in $\MT$ tail}
            
            \todo{}

            \subsection{Summary of background uncertainties at preselection}
