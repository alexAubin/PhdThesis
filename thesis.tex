...
%==============================================================
    ...
    \end{table}
       ...
       or known misreconstruction issues that lead to unphysical $\MET$ \cite{METperf}.
        ...
        \todo{Subsection still to be corrected}
...
$\lstop \rightarrow b \lchargino$ (0.5/450/50) & 398 $\pm$ 21              & 356 $\pm$ 20       & 306 $\pm$ 19      & 248 $\pm$ 16       \\
    ...
    \todo{Comment pro and cons of the methods}
...
\end{table}
            ...
            \begin{figure}[h!]
                \centering
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestSet_T2tt}
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestFOM_T2tt}\\
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestSet_T2bw075}
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestFOM_T2bw075}\\
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestSet_T2bw050}
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestFOM_T2bw050}\\
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestSet_T2bw025}
                \includegraphics[width=0.38\textwidth]{cutAndCountPerformances/bestFOM_T2bw025}
                ...
                \todo{Redo performance plot using the excluded signal strength formula+ contour at mu = 1}}                                                     
...
\end{table}
    ...
    disagreement ... ? SMP-14-020,  Michael's Monotop and AN-2014/114  see a disagreement 
    ...
    The values found are $\SFRoneLeptonTop = (1.38 \pm 0.61)$ and $\SFRWjets = (1.21 \pm 0.36)$.
        ...
        \subsection{Control of $\diLeptonTop$ component and second lepton veto}
        %==============================================================
