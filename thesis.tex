...
The philosophical and scientific approach share a common fundamental element, which is to
...
After the discovery of the top quark in 1995 at the Tevatron by the CDF and D0 experiments, % and then tau
...
%==============================================================
    ...
    corresponds to being able to offset the phase of the field in the same way accross all
    ...
    field $\psi_e$ accross space-time without changing the laws of physics.
    ...
    For these groups, the corresponding transformations are of the form
    \eq{SUNgauge}
    {
        \psi(x^\mu)
        \rightarrow
    ...
    arbitrary values and $t_k$ are the $n^2-1$ generators of $SU(n)$ satisfying the
    ...
    the matrices $t_k$ do not commute and leads to interaction terms between the gauge
    bosons $A^k_\mu$.
    ...
    generations, sharing the same charges as shown on \reftab{tab:StandardModelFields}.
    ...
    to the spontaneous breaking o the electroweak symmetry \cite{LectureStandardModelHiggsBoson}. Let's introduce a complex scalar $SU(2)$ doublet $\phi$ with $L_\phi = 1$ and $Y_\phi = 1$,
    \eq{higgsDoublet}
    {
        \phi
        =
    ...
    In this section, we focus especially on the hiearchy problem and dark matter as they
    ...
    %====================================================================================
        ...
        \begin{itemize}
            ...
            \item the soft gaugino masses, $\masstilde{\tilde{B}}$, $\masstilde{\tilde{W}}$ and $\masstilde{\tilde{g}}$ (usually noted $M_1$, $M_2$ and $M_3$ in the literature) ;
        ...
        this matrix. The chargino sector is therefore only described by $\masstilde{\tilde{W}}$,
        $\beta$ and $\mu$. For very large values of $\text{tan}\, \beta$, it is straightforward
        to see that the mass of the charginos tends to $\masstilde{\tilde{W}}$ and $\mu$.
        ...
        \eq{neutralinoMixingMatrix}
        {
            ...
            =
            \begin{pmatrix}
                \masstilde{\tilde{B}} & 0                     & - m_Z \,\text{cos}\, \beta \,\text{sin}\, \theta_W &   m_Z \,\text{sin}\, \beta \,\text{sin}\, \theta_W
                \\
                0                     & \masstilde{\tilde{W}} &   m_Z \,\text{cos}\, \beta \,\text{cos}\, \theta_W & - m_Z \,\text{sin}\, \beta \,\text{cos}\, \theta_W
                \\
        ...
        depends on $\masstilde{\tilde{B}}$, $\masstilde{\tilde{W}}$, $\beta$ and $\mu$.
        For example, for $\masstilde{\tilde{B}}$ and $\masstilde{\tilde{W}} \gg \mu$, the two lightest
...
%==============================================================
    ...
    performances of the algorithm. At the loose working point, the $b$ et efficiency is
...
%                     in the context of the validation of \textsc{Geant4} 10.0.patch1.}
    ...
    \subsection{Validation of new default pile-up rate for Run II validation samples}
    ...
    the fake and duplicate rate \refNeeded.}
    ...
    proved to be in agreement with the standard, and became part of the CMS workflow.
    ...
    was later tracked down as coming from the misidentification of the right primary vertex
    ...
    \insertTwoFigures{bTagging/highPU/TP}
                     ...
                     technique, and Phase 2 detector with a pile-up rate of 140 (red dots). \todo{ref to FTR-14-011}}
...
%==============================================================
    ...
    %==============================================================
        ...
        to the $\lneutralino$ when the SUSY parameters $\masstilde{\tilde{B}}$ and $\masstilde{\tilde{W}}$
...
Overall, the conclusions that will come out of the Run II will definetely shape the future
