...
% The vastness of the heavens streches my imagination - stuck on this carousel my little
% eye can catch one - million - year - old light. A vast pattern - of which I am a part...
% What is the pattern, or the meaning, or the why ? It does not do harm to the mystery to
% know a little about it. For far more marvelous is the truth than any artists of the past
% imagined it. Why do the poets of the present no speak of it ? What men are poets who can
% speak of Jupiter if he were are a man, but if he is an immense spinning sphere of methane
...
%==============================================================
    ...
    \begin{itemize}
        ...
        \item one scalar field leading to spontaneous symmetry breaking, called the
              Higgs field.
    \end{itemize}
    ...
    \subsubsection{Spontaneous breaking of the electroweak interaction}
    ...
    each other presence. This is referred to as assymptotic freedom. In comparison, if one
    would consider the analagous situation in electromagnetism, two particles close to
    each other feel important attraction or repulsion and are therefore not free. In this
    regime, $\alpha_S$ is small and predictions can be performed using perturbative QCD.
    ...
    to the system up to the point where this energy will be converted into new coloured
    ...
    a mathematical point of view. Moreover, this results in hadrons, such as protons,
    having a structure that cannot be computed from perturbative QCD.
    ...
    %====================================================================================
        ...
        \todo{say that it's not trivial to add a fourth generation of fermions}
        ...
        \todo{move this to additional symmetry part}
        ...
        is called a multiverse. What appears to be fine-tunning would in fact be
        ...
        This view is however controversial as it yields very little, if it not no testable
        ...
        group \refNeeded. The usual space-time symmetries, i.e. translations, boosts and rotations,
        are all bosonic symmetries. They noticed that another type of space-time symmetry
        with fermionic (i.e. spin 1/2) generators could also exist. Such a symmetry $Q$,
        ...
        Colemand and Mandula \todo{ref} that the only possible symmetry of Nature are the
        Poincaré symmetry and the gauge symmetries. Nevertheless, Haag, Lopuszanski and
        Sohnius later relaxed this theorem by noticing that another type of symmetry is
        possible and precisely corresponds to supersymmetry. \todo{Haag, Lopuszanski, Sohnius, 1975}
        ...
        Model for it to become supersymmetric. \todo{ref to 1201.0334 (Intro to MSSM), also
