...
%==============================================================
    ...
    the field. \todo{a work about virtual particles}
    ...
    \todo{introduce lagrangian for scalar, fermion, vector}
    ...
    where the kinetic term of $A_\mu$,
    \eq{Fmunu}
    {
        F_{\mu\nu}
        =
    ...
    was added. There are now two kinematic terms, a mass term and an interaction term with strength $q_e g$
    ...
    \eq{CovariantDerivativeSUn}
    {
        \Dslash
        =
        \dslash - i \cdot q_\psi g \cdot \gamma^\mu t_k G^k_\mu
    }
    ...
    themselvesi \todo{talk about chiral symmetry breaking}.
    ...
    term, the property should still hold in the limit where $m_e^0 \rightarrow 0$ and
    therefore the correction cannot be proportionnal to $\Lambda$. It is common to refer to
    this by saying that chiral symmetry protects the mass of fermions from diverging.
    ...
    gauge invariance preventing the mass terms.
    ...
    cannot be described without it, and found to represent $\orderOf{80\%}$ of the matter
    ...
    %====================================================================================
        ...
        the theory. The anthropic principle states that when studying the universe, it
        ...
        universes can only be the one allowing conscious life. This view is however controversial
        as it yields very little, if no testable prediction and can be interpreted as
        giving up on trying to understand the universe.

        \subsection{Supersymmetry}

        Here, we propose to have a close look at the idea of Supersymmetry. Supersymmetry,
        ...
        in the sense that it is a non-trivial extension of the Poincaré algebra. It can
        be noted that this is actually the only one possible. \todo{Haag, Lopuszanski, Sohnius, 1975}

        A remarkable property of SUSY is that trying to gauge it, that is making the
        ...
        Since the exact mechanism is unknown at the moment, one can simply consider that
        there are terms in the Lagrangian which are softly breaking the symmetry, leading
        to different masses between the superpartners.

        One of the initial motivation for supersymmetry is that it provides a mechanism that
        protects the mass of scalar bosons. In the case of the Higgs boson, one can show
        ...
        If SUSY is only softly broken, then as for chiral and gauge symmetry, then the
        ...
        Model for it to become supersymmetric. At each fermion and gauge boson is threfore
        associated a superpartner that we may call sfermion and gaugino. It should be
        once again stressed that left-handed and right-handed fermions are different
        fermions : therefore there are for example two selectrons, one associated to
        each chirality of the electron. Regarding the Higgs field, it is necessary to add
        not only a superpartner for it called higgsino, but also another Higgs field to
        ensure the concistency of the theory.

        \todo{more on pheno : table of susy particles, MSSM, cMSSM, pMSSM, pheno implications}
