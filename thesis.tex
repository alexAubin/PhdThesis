...
%==============================================================
    ...
    \section{Context and phenomenology \label{sec:analysis_contextAndPheno}}
        ...
        \insertFigure{illustrationHiggsProtection}{0.4}
                     {\todo{add figure} One-loop correction to the Higgs for a fermionic field $f$ and bosonic field $b$.}
        ...
        the corrections cancel each others. \todo{clarify link between $\lambda$ and masses..}
    ...
    The leading lepton must have $\pT > 17 \GeV$ while the second lepton must have $\pT > 8 \GeV$.
        ...
        from a multivariate analysis of the jet parameter and topology. The medium working point is used \todo{reference}.
           ...
           \subsubsection{Invariant masses, kinematic fit}
                ...
                \begin{itemize}
                    \item $M_{T2}^{W}$ ; $\MT$-like variables have been developed to target cases with two sources of missing energy
                                         in the event. \todo{reference} These extensions are often called $M_{T2}$. Here, we make use of
    ...
    \section{Systematic uncertainties \label{sec:analysis_systematics}}
        ...
        \subsection{Systematic uncertainties on the background \label{sec:background_systematics}}
            ...
            for these events is 6\% and is obtained from tag-and-probe studies \todo{reference 
            to SUS-13-011}. Regarding the $\tau$ veto lepton, the events considered are those 
        ...
        using the CT10, NNPDF 2.1, and MSTW2009 PDF sets. \todo{references} The impact on the
    ...
    \section{Signal contamination handling}
        ...
        The corrected background $\tilde{B}$ is computed the same way as described in Equations \todo{ref to equations}
