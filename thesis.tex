...
%==============================================================
    ...
    %==============================================================
        ...
        \todo{Description of main aspects of sensitivity : deltaM, xsec, offshell region, x (soft objects at low x)}

        \todo{Channels, advantages of the channels}
        ...
        %the illustrate the evolution of the mean generated $\MET$ and top $\pT$ as function of $(\mass{\lstop},
    ...
    \todo{also mention the W-tagging and perspective somehow here}
    ...
    the generated top quark to correct for a known disagreement \refNeeded. Finally, we also
           ...
           %==============================================================
                ...
                \begin{itemize}
                    ...
                    \item ISR-tagged jet ; Trying to reconstruct a jet from an ISR can provide significant gain especially 
                           ...
                           are more likely to be associated with a high-$\pT$ ISR because of the energy treshold needed to produce the stop pair. 
                           Here, we define the ISR-tagged jet by requiring a 5th jet with $\pT > 200 \GeV$ and not $b$-tagged.
                \end{itemize}
    ...
    %==============================================================
        ...
        \subsection{$W$-tagging in the high $\Delta m$ regime}
            ...
            \todo{Comparison between CA and AK performances for jet substructure done
            in http://arxiv.org/pdf/0903.5081v4.pdf}\todo{A comparison between AK, CA and 
            kt can be briefly presented in the detector chapter, algorithm/reconstruction
            section}
        ...
        and after cutting on $\MT > 120\GeV$.
            ...
            %table...
            \todo{To be updated with higher stat}
       ...
       $\mathcal{L} = 10\sim15\invfb$.
            ...
            \todo{To be updated with higher stat (and maybe a better FOM from Punzi parameter ?}


         \subsubsection{Expected benefits from new object reconstruction and selection techniques}
         % =====================================================

             % PUPPI jets, new isolation, 

         \subsubsection{Potential for new variables (?)}

             % MT significance, 
             % MT deconstruction, allowing to have more control to the regime looking at ? e.g. lower lepton pT  at low deltaM ?

             % ISR tagging improvement 

             % Topness ?

             % soft leptons ? or is that a different analysis ? how to probe high neutralino regime, low deltaM ?

             % FOM for optimization ?
            
             % statistical interpretation using multiple bin to simultaneously fit S and B ?
    ...
    %==============================================================
        ...
        % Other production mode

        \subsection{Gluino mediated ?}
        
        \subsection{t2 -> H t1 -> ... ?}
        
        % Specific part of the mass space
