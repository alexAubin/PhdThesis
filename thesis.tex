...
%==============================================================
    ...
    \section{The Compact Muon Solenoid experiment}
        ...
        limit where the particle is produced along the beam axis. In the plane ($\phi$,$\eta$),
        we define the distance between two particles as
        ...
        on the vertex to less than one milimeter. While being this accurate, the instrument
        must be able to handle the conditions of the LHC. At nominal conditions,
        it can be estimated that about 1000 charged particles are produced for every bunch
        crossing each 25 ns. This roughly corresponds to a hit rate of 1 MHz/mm$^2$ at 4
        cm of the interaction point and 3 kHZ/mm$^2$ at 115 cm.
        ...
        % Challenges : sustain 10MHz at 4 cm, ...

        % Goals : tracks, vertex, with precision blah

        % Sub structures : pixel, TIB, TOB, ..., coverage
        % Size of each fundamental components : pixel, strips, ...


        \loremipsum
            \subsubsection{Electromagnetic calorimeter}

            \insertFigure{CMS/ECAL}{0.6}{}
