...
\newpage
\thispagestyle{empty}
\newgeometry{top=1.2cm, bottom=1.2cm, left=1.2cm, right=1.2cm, bindingoffset=0cm}
\singlespace
\begin{center}\textsc{Résumé}\end{center}
    \vspace*{-0.2cm}
    La découverte d'un boson de Higgs ayant les propriétés prédites par le Modèle Standard
autour de $125\GeV$ par CMS et ATLAS en 2012 renforce la nécessité de répondre au problème
de hiérarchie. La supersymmétrie propose une solution naturelle à ce problème, c'est-à-dire
qui nécessite peu d'ajustement fin des paramètres de la théorie pour expliquer la masse
du Higgs observée. Dans les réalisations naturelles de la supersymmétrie, le partenaire
scalaire du quark top, le stop ($\lstop$), doit avoir une masse en dessous du
TeV tandis que le plus léger des neutralinos ($\lneutralino$), qui est un candidat pour
la matière noire dans les modèles avec $R$-parité conservée, est attendu avec une masse
de quelques centaine de GeV.

    Cette thèse est centrée sur la recherche de production directe de paire de stop
...
s'effectue dans les événements avec exactement un lepton, au moins quatre jets dont au moins
un est étiquetté comme provenant d'un quark $b$, et une grande quantité d'énergie transverse
manquante.

    Le travail de ce thèse a permis d'améliorer la définition du veto sur un deuxième lepton,
visant à rejeter les événements $t\bar{t}$ dileptoniques passant la sélection. Des régions
de signal basée sur des coupures ont été définies et optimisées et ont permis de recouper
les résultats obtenus avec une approche basée sur des arbres de décision boostés. Une nouvelle
méthode d'ajustement des contributions a été integrée pour estimer les bruits de fond
$t\bar{t}$ semileptonique et $W$+jets. Une procédure a été développée pour corriger des effets
de contamination de signal. Les résultats ont été interprétés en terme de contrainte sur
l'espace ($\mass{\lstop}$,$\mass{\lneutralino}$), allant jusqu'à $700\GeV$ en terme de
masse du stop et $250\GeV$ en terme de masse du neutralino.

    Finallement, l'utilisation de techniques d'étiquettage de $W$ a été investiguée pour le
futur de cette recherche dans le régime boosté, et une estimation de la sensibilité de
l'analyse pour le début du Run II du LHC a été étudiée.

\begin{center}\textsc{Abstract}\end{center}
    \vspace*{-0.2cm}
    The discovery of a Standard Model-like Higgs boson around $125\GeV$ by the CMS and ATLAS
experiments in 2012 reinforces the need to address the hierarchy problem. Supersymmetry propose a natural
solution to this problem, meaning that it requires low fine tunning of the parameters of
the theory to explain the observed Higgs mass. In natural realization of supersymmetry,
the scalar partner of the top quark, the stop ($\lstop$), is expected to be lighter than the TeV
scale while the lightest neutralino ($\lneutralino$), which is a dark matter candidate in
$R$-parity conserved model, is expected to have a mass of a few hundred GeV.
...
transverse energy.
    ...
    The work of this thesis helped improve the second lepton veto definition, aiming to
reject dileptonic $t\bar{t}$ events passing the selection. Cut-based signal regions have
been designed and optimized, providing a mean to cross-check the boosted decision tree
approach of this analysis. A new method relying on a template fit was integrated to estimate
the semileptonic $t\bar{t}$ and $W$+jets backgrounds, and a procedure to correct for signal
contamination has been developped. The results were interpreted in terms of constrains in
the ($\mass{\lstop}$,$\mass{\lneutralino}$) space, going up to $700\GeV$ in terms of stop
mass and $250\GeV$ in terms of neutralino mass.

    Finally, the use of $W$-tagging techniques have been investigated for the future of the search
in the boosted regime, and an estimation of the sensitivity for the beginning of the Run II
of the LHC has been studied.
