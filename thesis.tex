...
%==============================================================
    ...
    In \refsection{sec:bJetProperties}, we will discuss the $B$ hadrons and $b$ jet properties,
    which are the starting point of $b$-tagging, followed in \refsection{sec:bTagAlgorithms}
    by the discussion of $b$-tagging strategy and algorithms. In \refsection{sec:bTagValidation},
    ...
    The situation is summarize on \reffig{fig:bTagging/impactParameter}. To reject
    ...
    \insertFigure{bTagging/impactParameter}{0.75}
                 {Representation of the computation of the impact parameter, taking as
    ...
    \todo{plot to illustrate the discriminating power of IP, IPsig}
    ...
    \todo{plot to illustrate the discriminating power of vertex mass, vertex decay length}
    ...
    \todo{plot to illustrate the discriminating power of pT rel, SIP3d}

    \subsection{Algorithms}

    % performance definition goes here
    ...
    \todo{plot to illustrate the TCHE discriminant and perf}
    ...
    \todo{plot to illustrate the JP discr and perf}
    ...
    \todo{plot to illustrate the SSV discr and perf}
    ...
    \todo{plot to illustrate the SMT or SET discr and perf}
    ...
    \todo{plot to illustrate the CSV discr and perf}
    ...
    and the tracks reconstructed, in a $H \rightarrow bb$ candidate event produced through
    ...
    is found to be close to $125 \GeV$. \todo{HIG-13-011}}
    ...
    {
        \frac{\sigma_\epsilon}{\epsilon} = \sqrt{\frac{1}{N} \frac{1-\epsilon}{\epsilon}} > 0.1
        \hspace*{1cm}
        \Rightarrow
        \hspace*{1cm}
        \epsilon < \frac{1}{\frac{N}{100} + 1}
    }
    ...
    steps of previous validation samples, in order to factorize the statistical fluctuations.
        ...
        the performances of the CSV algorithm, shown on \reffig{fig:bTagging/newGeant4}.

        \insertTwoFigures{bTagging/newGeant4}
                         {bTagging/newGeant4/TTbar_710pre4_newGeant_HS_vs_710pre4_HS_FullSim_lowLevelVariables/CSVTag_trackSip3dSig_GLOBAL_all}
        ...
        \insertFigure{bTagging/newPU35/tracking}{0.95}{caption}
        ...
        Figure \reffig{fig:bTagging/newPU35/performances} presents the impact on the performance
